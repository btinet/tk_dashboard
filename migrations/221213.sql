...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 13. Dez 2022 um 18:59
...
(121, 1, '﻿Inwiefern wirken Lebewesen der Entropie entgegen?', 2016, '2022-12-12 13:14:36', NULL),
(122, 1, 'Inwiefern beeinflussen Emoticons die deutsche Sprache?', 2012, '2022-12-12 13:14:36', NULL),
(123, 1, '﻿Inwiefern sind wir der Mittelpunkt des Universums?', 2016, '2022-12-13 10:27:00', NULL),
(124, 1, 'Inwieweit lässt sich Wasser trinken?', 2012, '2022-12-13 10:27:00', NULL);
...
(17, 20, 3, 2, 'Antrag angelegt', '2022-12-12 20:27:40', NULL),
(18, 21, 3, 5, 'Antrag angelegt', '2022-12-12 20:30:38', NULL),
(19, 22, 3, 2, 'Antrag angelegt', '2022-12-13 10:42:01', NULL),
(20, 23, 3, 2, 'Antrag angelegt', '2022-12-13 17:33:25', NULL),
(21, 24, 3, 5, 'Antrag angelegt', '2022-12-13 17:35:18', NULL);
...
(237, 121, 1, 2, 1, '2022-12-12 13:14:36', '2022-12-13 17:33:25'),
(238, 121, 12, 2, 0, '2022-12-12 13:14:36', '2022-12-13 17:33:25'),
(239, 122, 5, 5, 1, '2022-12-12 13:14:36', '2022-12-13 17:35:18'),
(240, 122, 4, 5, 0, '2022-12-12 13:14:36', '2022-12-13 17:35:18'),
(241, 123, 12, NULL, 1, '2022-12-13 10:27:00', NULL),
(242, 123, 11, NULL, 0, '2022-12-13 10:27:00', NULL),
(243, 124, 1, NULL, 1, '2022-12-13 10:27:00', '2022-12-13 10:44:54'),
(244, 124, 2, NULL, 0, '2022-12-13 10:27:00', '2022-12-13 10:44:52');
...
(25, 'has_supervisor', 'Kann betreuende Person sein', '2022-12-12 06:33:36', NULL);
...
(18, 'Geschichte', 'ge', 7, '#FFBF00', '2022-09-10 15:50:21', '2022-12-11 07:42:23'),
...
(24, 'Musik', 'mu', 8, '#fc03f0', '2022-12-10 21:32:19', '2022-12-11 06:48:51');
...
(14, 2, '2022-12-08 07:19:01', '2022-12-12 10:23:36', 'Inwieweit können 3D-Drucker die Organspende revolutionieren?', 2, 1, 4, 6),
(15, 2, '2022-12-10 08:20:48', '2022-12-12 10:23:38', 'Inwieweit können 3D-Drucker die Organspende revolutionieren?', 2, 1, 4, 6),
(20, 2, '2022-12-12 20:27:40', NULL, 'Inwiefern beeinflussen Emoticons die deutsche Sprache?', 1, 5, 4, 6),
(21, 5, '2022-12-12 20:30:38', NULL, '﻿Inwiefern wirken Lebewesen der Entropie entgegen?', 1, 1, 12, 6),
(22, 2, '2022-12-13 10:42:01', NULL, 'Inwieweit lässt sich Wasser trinken?', 1, 1, 2, 6),
(23, 2, '2022-12-13 17:33:25', NULL, '﻿Inwiefern wirken Lebewesen der Entropie entgegen?', 1, 1, 12, 6),
(24, 5, '2022-12-13 17:35:18', NULL, 'Inwiefern beeinflussen Smileys die deutsche Sprache?', 1, 5, 4, 6);
...
CREATE TABLE `user_role_has_user` (
  ...
  `user_id` int(11) DEFAULT NULL,
  `user_role_id` int(11) DEFAULT NULL,
  `attribs` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL DEFAULT '{}' COMMENT '(DC2Type:json)',
...
INSERT INTO `user_role_has_user` (`id`, `user_id`, `user_role_id`, `attribs`, `from`, `to`, `created`, `updated`) VALUES
(1, 5, 10, '{}', '2022-12-11', NULL, '2022-11-05 06:11:38', '2022-12-11 21:19:06'),
(2, 2, 1, '{}', '2022-12-11', NULL, '2022-11-05 13:55:19', '2022-12-11 21:19:03'),
(4, 6, 9, '{}', '2022-12-11', NULL, '2022-11-10 05:31:11', '2022-12-11 21:18:59'),
(5, 2, 10, '{}', '2022-12-11', NULL, '2022-12-04 07:21:28', '2022-12-11 21:18:54'),
(6, 6, 18, '{\"supervise\":{\"pupil_amount\":\"6\",\"supervise_enable\":\"on\"}}', '2022-12-11', NULL, '2022-12-08 17:00:27', '2022-12-13 17:34:39'),
(7, 5, 11, '{}', '2022-12-11', '2023-08-06', '2022-12-11 21:20:35', NULL);
...
ALTER TABLE `user_has_exam`
  ...
  ADD CONSTRAINT `user_has_exam_ibfk_8` FOREIGN KEY (`supervisor_id`) REFERENCES `user` (`id`) ON UPDATE CASCADE;
