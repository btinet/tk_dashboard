                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <div class="card card-body shadow-sm">
                                    <p class="card-text">Dieser Sidebar befindet sich noch in der Entwicklung. Alle Elemente ohne Funktion.</p>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                                <button type="reset" class="btn btn-primary w-100 d-block">Leitfrage einreichen</button>
                            </div>
                            <div class="col-12">
                                <a href="#" class="btn btn-light border-1 border-secondary d-block">abbrechen</a>
                            </div>
                        </div>
                    </div>
                </div>
